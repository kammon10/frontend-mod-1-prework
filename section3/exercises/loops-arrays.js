...
var cutness = ["bunny", "goat", "elephant", "puppy"];
for (var i = 0; i < cutness.length; i++) {
  console.log(cutness[i] + " is awesome!");
}


// YOU DO: Create an array of foods and then iterate over that array to log "Add
// <food> to shopping list" for each food item.
var list = ["pickles", "Pretzels", "pizza",];
for (var i = 0; i < list.length; i++) {
  console.log("add" + " " + list[i] +  " " + "to the list");
}
