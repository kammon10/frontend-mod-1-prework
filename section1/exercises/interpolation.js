...
// Your answer and explanation here: a string including interpolation will be loged because the string uses synax ${variables_name} in the string.
...
var child = "boy";
var gift = "bike";
console.log( `the ${age} ${child} wanted a ${gift} for his birthday`);
